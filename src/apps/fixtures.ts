...
export const appDetails: NonNullable<AppQuery["app"]> = {
  ...
  accessToken: "token",
  appUrl: "http://10.142.0.2:8888/app",
  manifestUrl: "http://10.142.0.2:8888/api/manifest",
  configurationUrl: "htpp://10.142.0.2:8888/configuration",
  created: "2020-06-02T12:24:26.818138+00:00",
  dataPrivacy: "Lorem ipsum",
  dataPrivacyUrl: "http://10.142.0.2:8888/app-data-privacy",
  homepageUrl: "http://10.142.0.2:8888/homepage",
  id: "QXBwOjE4MQ==",
  isActive: true,
  metadata: [],
  name: "app1",
  ...
  privateMetadata: [],
  supportUrl: "http://10.142.0.2:8888/support",
  tokens: [],
  type: AppTypeEnum.THIRDPARTY,
  version: "1.0.0",
  webhooks: [],
